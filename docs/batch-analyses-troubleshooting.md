...
For VICE (interactive) app problems, see [vice-troubleshooting.md](vice-troubleshooting.md).
...
Via the RabbitMQ management UI (usually at `http://$RABBITMQ_HOST:15672`) or via the API:
...
See [irods.md](irods.md) for more detailed iRODS diagnostics.
