...
* [Running the Ansible Playbooks](/playbooks/running-ansible.md) - The three ways to get an Ansible control environment for this repo — the uv-managed project, a system Ansible install, and the macOS system-Python interpreter override.
