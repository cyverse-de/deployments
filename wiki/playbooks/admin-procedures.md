---
type: Runbook
title: DE Administration Procedures
description: User-facing admin tasks via the Terrain admin API and Sonora admin panel — subscriptions, VICE access, workshops, DOI requests, alerts, and app moderation.
resource: /docs/admin-procedures.md
tags: [admin, terrain, sonora, subscriptions, vice, doi, workshops]
...
> `admin_groups` in the inventory. See [Keycloak](/infrastructure/keycloak.md) §4 for group
> management.
...
See [Keycloak](/infrastructure/keycloak.md) §9 for the impersonation procedure.
...
[1] `docs/admin-procedures.md` — source document for this page.
