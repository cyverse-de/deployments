...
* [discoenv-users](/services/discoenv-users.md) - NATS-based service providing DE user information from the DE database to other discoenv services.
...
* [jex-adapter](/services/jex-adapter.md) - HTTP front door for batch analysis submissions, bridging the DE to the job-execution backend over AMQP and NATS.
...
* [qms-adapter](/services/qms-adapter.md) - Adapter that bridges the DE AMQP exchange and QMS, forwarding usage updates to the QMS admin usages endpoint.
* [qms](/services/qms.md) - The Quota Management Service, tracking subscription plans and resource usage in its own PostgreSQL database and exchanging updates over AMQP.
...
* [terrain](/services/terrain.md) - The DE's public API gateway, routing UI requests to the backend services and talking to iRODS, Keycloak, and NATS directly.
